...
set expandtab tabstop=2 shiftwidth=2 softtabstop=2 " Default tab setting is \m
...
if !has('gui_running')
  if $TERM == "xterm-256color" || $TERM == "screen-256color" || $COLORTERM == "gnome-terminal" || $TERM == "xterm"
    set t_Co=256
